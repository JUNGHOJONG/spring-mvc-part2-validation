...
//    @PostMapping("/{itemId}/edit")
    public String editItemV1(@PathVariable Long itemId, @Validated @ModelAttribute Item item, BindingResult bindingResult, Model model) {
    ...
    @PostMapping("/{itemId}/edit")
    public String editItemV2(@PathVariable Long itemId, @Validated(UpdateCheck.class) @ModelAttribute Item item, BindingResult bindingResult, Model model) {
